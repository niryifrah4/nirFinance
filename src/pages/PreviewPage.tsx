...
const faqItems = [
    {
        ...
        answer:
            "לזוגות ומשפחות שמסתדרים אבל אין להם תמונה שלמה — ולאנשים שנמצאים במינוס ורוצים לצאת ממנו. בין אם יש לכם הכנסה יציבה ואין תוכנית, ובין אם אתם מרגישים שהכסף ״נעלם״ בסוף החודש — יש כאן עבודה משמעותית שאפשר לעשות ביחד. גם רווקים שרוצים להניח בסיס פיננסי בריא לפני שלב החיים הבא — מוזמנים בחום.",
    },
    {
